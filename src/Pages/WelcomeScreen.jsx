...
// import AOS from "aos";
// import "aos/dist/aos.css";
// import { SparklesCore } from "../components/ui/sparkles"; // Import the SparklesCore component
...
const BackgroundEffect = () => (
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-r from-black to-[#000033] blur-3xl animate-pulse" />
    <div className="absolute inset-0 bg-gradient-to-tr from-[#000033]/10 via-transparent to-[#000066]/10 blur-2xl animate-float" />
  </div>
);

const IconButton = ({ Icon }) => (
  <div className="relative group hover:scale-110 transition-transform duration-300">
    <div className="absolute -inset-2 bg-gradient-to-r from-[#000033] to-[#000066] rounded-full blur opacity-30 group-hover:opacity-75 transition duration-300" />
    <div className="relative p-2 sm:p-3 bg-black/50 backdrop-blur-sm rounded-full border border-white/10">
      <Icon className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
    </div>
  </div>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  <div className="mb-2 sm:mb-4">
                    <span
                      data-aos="fade-right"
                      data-aos-delay="200"
                      className="inline-block px-2 bg-gradient-to-r from-white via-[#000033] to-[#000066] bg-clip-text text-transparent"
                    >
                      Welcome
                    </span>{" "}
                    <span
                  ...
                  <div>
                    <span
                      data-aos="fade-up"
                      data-aos-delay="800"
                      className="inline-block px-2 bg-gradient-to-r from-[#000033] to-[#000066] bg-clip-text text-transparent"
                    >
                      Portfolio
                    </span>{" "}
                    <span
